"""
Django settings for segdnn_dev_134897 project.
...
ROOT_URLCONF = 'segdnn_dev_134897.urls'
...
WSGI_APPLICATION = 'segdnn_dev_134897.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "segdnn_dev_134897 API",
    "DESCRIPTION": "API documentation for segdnn_dev_134897 App",
    "VERSION": "v1",
}
